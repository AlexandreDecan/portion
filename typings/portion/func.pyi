...
def openclosed(lower, upper, *, klass=...):
    """
...
def closedopen(lower, upper, *, klass=...):
    """
...
def iterate(interval, step, *, base=..., reverse=...):
    """
