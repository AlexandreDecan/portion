...
def from_string(string, conv, *, bound=..., disj=..., sep=..., left_open=..., left_closed=..., right_open=..., right_closed=..., pinf=..., ninf=..., klass=...): # -> Interval:
    """
...
def to_string(interval, conv=..., *, disj=..., sep=..., left_open=..., left_closed=..., right_open=..., right_closed=..., pinf=..., ninf=...): # -> str:
    """
