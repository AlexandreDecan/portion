...
This type stub file was generated by pyright.
"""
def from_string(string, conv, *, bound=..., disj=..., sep=..., left_open=..., left_closed=..., right_open=..., right_closed=..., pinf=..., ninf=..., klass=...):
    """
...
def to_string(interval, conv=..., *, disj=..., sep=..., left_open=..., left_closed=..., right_open=..., right_closed=..., pinf=..., ninf=...):
    """
...
def from_data(data, conv=..., *, pinf=..., ninf=..., klass=...):
    """
...
def to_data(interval, conv=..., *, pinf=..., ninf=...):
    """
